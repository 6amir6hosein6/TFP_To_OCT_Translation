...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/amd/') 
        ...
        self.parser.add_argument('--camlabel', action='store_true', help='use CAM conditioned label')
        
        self.initialized = True

    def parse(self, save=True, verbose=False, inference=False):
